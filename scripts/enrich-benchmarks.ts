...
import {
  ...
  type CpuFields,
  type GpuFields,
} from '@/lib/benchmarks/parse-nanoreview';
...
// Parsers y tipos de campos curados viven en lib/benchmarks/parse-nanoreview.ts
// (puros, testeados con fixtures). Aquí solo va la extracción del DOM + I/O.

// ─── Extracción del DOM de nanoreview ────────────────────────────────────────
